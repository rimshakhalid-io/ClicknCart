            ...
            <section class="bg-slate-900 dark:bg-gray-900">
                <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 grid lg:grid-cols-2 gap-8 lg:gap-16">
                    <div class="flex flex-col justify-center">
                        <h1 class="mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-200 md:text-5xl lg:text-6xl ">We invest in the world’s potential</h1>
                        <p class="mb-6 text-lg font-normal text-gray-300 lg:text-xl dark:text-gray-400">Here at ClicknCart we focus on markets where technology, innovation, and capital can unlock long-term value and drive economic growth.</p>
                        <a href="#" class="text-orange-700 hover:underline font-medium text-lg inline-flex items-center">Read more about our store
                        ...
                        <div class="w-full lg:max-w-xl p-6 space-y-8 sm:p-8 bg-slate-800 rounded-lg shadow-xl dark:bg-gray-800">
                            ...
                            <form class="mt-8 space-y-6" action="#">
                                ...
                                <div class="flex items-start">
                                    ...
                                    <a href="#" class="ms-auto text-sm font-medium text-gray-200 hover:underline dark:text-orange-700">Lost Password?</a>
                                </div>
                                <button type="submit" class="w-full px-5 py-3 text-base font-medium text-center text-white bg-orange-700 rounded-lg hover:bg-red-400  focus:ring-4 focus:ring-blue-300 sm:w-auto dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Login to your account</button>
                                <div class="text-sm font-medium text-gray-200 dark:text-white">
                                    Not registered yet? <a class="text-orange-700 hover:underline ">Create account</a>
                                </div>
                            </form>
                        </div>
                    </div>
